...
class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        float[] Yellow = { 0.5f, 0.55f, 0.12f, 1 };
        float[] zero = { 0, 0, 0, 1 };
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, Yellow, 0);
    ...
    public void PyramidBaseOnCircle(GL2 gl2,int numVertices){
        ...
        for (int i = 1; i <= numVertices; i++) {
            ...
            //gl2.glMaterialfv(GL2.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, materials[i],4);//gradient
